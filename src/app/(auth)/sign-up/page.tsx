...
import { Rss, Mail, Lock, User, Eye, EyeOff, ArrowRight } from 'lucide-react'
    ...
    <div className="min-h-screen bg-parchment-100 dark:bg-night-900 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-sage-600 dark:bg-sage-800 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative text-center text-white max-w-md">
          ...
          <h1 className="font-display text-4xl mb-4">Start reading smarter</h1>
          <p className="text-sage-100 text-lg leading-relaxed">
            Subscribe to your favorite sources, get AI-powered summaries, and never miss what matters.
          </p>
          <div className="mt-8 space-y-3 text-left max-w-sm mx-auto">
            {['Unlimited RSS feeds', 'AI summaries included', 'No credit card required'].map((item, i) => (
              <div key={i} className="flex items-center gap-3">
                ...
                <span className="text-sage-100">{item}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <h2 className="font-display text-3xl text-ink-900 dark:text-white mb-2">Create account</h2>
          <p className="text-ink-500 dark:text-ink-400 mb-8">
            Already have an account?{' '}
            <Link href="/sign-in" className="text-sage-600 dark:text-sage-400 hover:underline font-medium">
              Sign in
            </Link>
          </p>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-parchment-100 dark:bg-night-900 text-ink-500 dark:text-ink-400">or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User className="h-4 w-4 absolute left-4 top-1/2 -translate-y-1/2 text-ink-400" />
                <input
                  type="text"
                  value={name}
            ...
            <p className="text-xs text-ink-500 dark:text-ink-400 text-center">
              ...
              <Link href="/terms" className="underline hover:text-ink-700 dark:hover:text-ink-300">Terms</Link>{' '}
              and{' '}
              <Link href="/privacy" className="underline hover:text-ink-700 dark:hover:text-ink-300">Privacy Policy</Link>
            </p>
          </form>
        </div>
      </div>
